...
#define STRING_CONFIG_H_AUTHOR "deram@iki.fi" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Pi3 ProB"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // My Geetech hotend + part cooling
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2560, 96.3 }
 ...
 *
 */
//D#define Z_MIN_PROBE_ENDSTOP
//D#define Z_MIN_PROBE_PIN Z_MAX_PIN
